...
def log_analysis_complete(correlation_id: str, issues_found: int, duration_ms: int) -> None:
...
def log_llm_response(correlation_id: str, response_length: int, duration_ms: int) -> None:
